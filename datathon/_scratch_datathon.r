...
##### ETL -----
### 3 milion obs of birds and cleaning 
#
# dummy <- 
...
# ### setup ggmap with API key:
# ## see https://stackoverflow.com/questions/52565472/get-map-not-passing-the-api-key-http-status-was-403-forbidden
# remove.packages("ggmap")
# devtools::install_github("dkahle/ggmap", ref = "tidyup")

# library(ggmap)
# register_google(key = "AIzaSyAjUn8O8jK0m4rQhrcj2l5n86JwBDaWXE8") 
# ggmap(get_googlemap())   
